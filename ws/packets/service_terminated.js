...
module.exports = {
  ...
  call: (ws, request, client, data, clients) => {
    ...
    var msg =
      "[ALERTE]\n\n Le service vient d'être indiqué comme terminé par " +
      service.recipient.username +
      "\nVous avez 7 jours à compté de maintenant pour déclarer un litige.\nPensez également à notre la prestation :)\n\n [ALERTE]";
